        ...
        <div class="container-table-cart pos-relative">
            <div class="wrap-table-shopping-cart bgwhite">
                ...
                if ($this->session->flashdata('sukses')) {
                    ...
                    <h5><i class="icon fa fa-ban"></i> Sukses!</h5>';
                    echo $this->session->flashdata('sukses');
                    echo '</div>';
        
                    if ($this->session->flashdata('sukses_cekout')) {
                ...
                <table class="table-shopping-cart">
                    ...
                    <?php echo form_close(); } ?>
                    <!-- form close end looping data keranjang belanja -->
                ...
                <?php
                    ...
                    echo form_open(base_url('belanja/bayar'));
                    ...
                    <tr>
                        ...
                        <th><input type="text" name="kode_transaksi" class="form-control" value="<?php echo $kode_transaksi; ?>" readonly ></th>
                    </tr>
                    <tr>
